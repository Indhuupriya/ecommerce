...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::to('admin/css/sb-admin-2.min.css') }}">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" id="search-form">
                        <div class="input-group">
                            <input type="text" name="query" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" id="search-input">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <?php 
                                    $profile = URL::to('storage/profile_image/' . Auth::user()->profile_image);
                                ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.order-status').on('change', function() {
                ...
                if (status === 'completed') {
                    if (!confirm('Are you sure you want to set this order as completed? This action cannot be undone.')) {
                        $(this).val('pending');
                        return;
                    }
                }
